...
export default {
    ...
    created() {
        // call  to server to get views of this blog post...
        this.views = 100
        // get the blog post
        let posts = [ { title : 'this is blog title 1', 'post' : 'this is a blog post 1', id :1},
                { title : 'this is blog title 2', 'post' : 'this is a blog post 2', id :2},
                { title : 'this is blog title 3', 'post' : 'this is a blog post 3', id :3},
                { title : 'this is blog title 4', 'post' : 'this is a blog post 4 ', id :4},]
        this.blogs = posts
    }
}
</script>
